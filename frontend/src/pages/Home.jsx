...
const Home = () => {
  ...
  return (
    <div className="h-screen relative overflow-hidden font-ubermove">
      <img
      ...
      <div className="h-screen flex flex-col justify-end absolute top-0 w-full">
        <div className="h-[30%] p-6 bg-white relative">
          ...
          <button className="bg-black text-white px-4 font-semibold py-2 rounded-lg w-full">
            Find Trip
          </button>
        </div>
      ...
      <div
        ref={vehiclePanelRef}
        className="fixed w-full z-10 bottom-0 px-3 py-10 pt-10 translate-y-full bg-white"
      >
        <VehiclePanel
